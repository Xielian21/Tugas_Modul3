...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK 1772</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    mtk3 = st.sidebar.number_input("Nilai Matematika Semester 2.1", 68.0, 99.0)
    ...
    input_data = [mtk1, mtk2, mtk3, mtk4, ing1, ing2, ing3, ing4, ind1, ind2, ind3, ind4,
              kkm_mtk1, kkm_mtk2, kkm_mtk3, kkm_mtk4, kkm_ing1, kkm_ing2, kkm_ing3, 
              kkm_ing4, kkm_ind1, kkm_ind2, kkm_ind3, kkm_ind4]
